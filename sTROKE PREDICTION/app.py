...
def predictAction():
    if request.method == 'POST':
        ...
        wktype={'privatejob':4,'govtemp':1,'selfemp':8}
        smke={'formerly-smoked':1,'non-smoker':2,'smoker':7}
        hypten={'hypten':9,'nohypten':0}
        hrtdis={'heartdis':10,'noheartdis':0}
